...
playerturn=ttk.Label(root,text="   Spieler 1 zug!  ")
playerturn.grid(row=3,column=0,sticky='snew',ipadx=40,ipady=40)

playerdetails=ttk.Label(root,text="    Spieler 1 ist X\n\n    Spieler 2 ist O")
playerdetails.grid(row=3,column=2,sticky='snew',ipadx=40,ipady=40)

res=ttk.Button(root,text='Neustart')
...
def ButtonClick(id):
    ...
    if( bu1['text']=='X' and bu2['text']=='X' and bu3['text']=='X' or
        ...
        bu3['text']=='X' and bu5['text']=='X' and bu7['text']=='X'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tic Tac Toe","Gewinner ist Spieler 1")
        ...
        bu3['text']=='O' and bu5['text']=='O' and bu7['text']=='O'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tic Tac Toe","Gewinner ist Spieler 2")
    elif b==9:
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tic Tac Toe","Spiel ist unentschieden!")

    if a==1 and c==0:
        playerturn['text']="   Spieler 1 zug!   "
    elif a==0 and c==0:
        playerturn['text']="   Spieler 2 zug!   "
